<template>
    <v-main>
        ...
        <!-- {{ arr }} -->
        <v-container v-if="watchlistStore.watchlistCount > 0">
            <h1 class="text-h4 font-weight-bold py-3"> <v-icon icon="mdi-view-list" size="sm"></v-icon> My Watchlist</h1>
            <!-- <v-chip>{{ watchlistStore.folderCount }} of 20 Documents</v-chip> -->
...
onMounted( () => {
    ...
    if(watchlistStore.watchlist.length > 0){
        arr.value = watchlistStore.watchlist
    }
})
</script>